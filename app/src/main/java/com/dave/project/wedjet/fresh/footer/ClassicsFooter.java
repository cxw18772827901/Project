...
import com.dave.project.wedjet.fresh.internal.pathview.PathsDrawable;
...
//    }
    ...
    public ClassicsFooter setProgressResource( int resId) {
        mProgressDrawable = null;
    ...
    public ClassicsFooter setArrowResource( int resId) {
        mArrowDrawable = null;
